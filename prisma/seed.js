...
async function main() {
  ...
  const defaultSettings = [
    ...
    { key: 'owner_bio', value: 'Results-driven creative professional with 5+ years of experience in video editing, graphic design and UI/UX design.\n\nSpecialised in ad videos, reels, social media content, brand identity design and Figma-based website design — currently working as Graphics, UI/UX Designer & Video Editor at Elaris Consulting, a real estate company.\n\nPassionate about storytelling and visual aesthetics, helping brands stand out through compelling, engaging creative solutions.' },
